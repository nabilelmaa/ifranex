...
const StepCard: React.FC<Step & { index: number; isInView: boolean }> = ({
    title,
    description,
    icon,
    index,
    ...
    return (
      <div
        className={`relative flex flex-col h-full border rounded-md shadow-sm cursor-pointer duration-50 bg-white p-4 transform transition-transform duration-500 ${
